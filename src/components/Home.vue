          ...
          <div class="w-full justify-center flex p-5">
            <div class="relative w-2/3">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="w-5 h-5 absolute top-1/2 left-3 transform -translate-y-1/2 text-gray-400">
                <path stroke-linecap="round" stroke-linejoin="round"
                  d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
              </svg>
            </div>
            <button
              class="bg-blue-500 text-white px-8 rounded-md mx-1 font-semibold hover:bg-blue-950 transition-all">Buscar</button>
          </div>
